...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Website-matching color palette: Blues and Emerald greens (reduced intensity)
    function generateColor(): ColorRGB {
      const colorPalettes = [
        // Blue tones (matching #3B82F6)
        { r: 0.23, g: 0.51, b: 0.96 },  // Blue-500
        { r: 0.14, g: 0.42, b: 0.88 },  // Blue-600
        { r: 0.19, g: 0.62, b: 1.0 },   // Blue-400
        
        // Emerald tones (matching #10B981)
        { r: 0.06, g: 0.73, b: 0.51 },  // Emerald-500
        { r: 0.03, g: 0.59, b: 0.41 },  // Emerald-600
        { r: 0.21, g: 0.84, b: 0.63 },  // Emerald-400
        
        // Cyan accents
        { r: 0.08, g: 0.78, b: 0.82 },  // Cyan-500
        { r: 0.14, g: 0.67, b: 0.85 },  // Sky-500
      ];
  ...
  return (
    <div className="fixed inset-0 pointer-events-none w-full h-full overflow-hidden" style={{ zIndex: 9999 }}>
      <canvas ref={canvasRef} id="fluid" className="w-full h-full block" style={{ mixBlendMode: 'screen' }}></canvas>
    </div>
  );
}
